...
public class EnterPoint {
    public static void main(String[] args) {
        ...
        String[][] stringArray5 = new String[3][3];
        ...
        checkMyExceptions(stringArray1);    //  должны получить 1
    ...
    public static void sumElemsInArray(String[][] array) throws MyArraySizeException, MyArrayDataException{
        ...
        int sumBuffer = 0;
        //  Проверка входного массива любой размерности на соответствие требованию быть не более 4х4
        for (String[] elem : array) {
            if (array.length > 4 || elem.length > 4) {
                throw new MyArraySizeException("Некорректный размер исходного массива!!!");
            }
        }
